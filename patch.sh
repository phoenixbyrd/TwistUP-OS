...
getchangelog() {
  ...
  messagetxt="$(wget -qO- https://twisteros.com/Patches/Twister_OS/message.txt)"
...
patch2url() {
  ...
  URL="$(wget -qO- https://twisteros.com/Patches/Twister_OS/URLs | grep "$1" | awk '{print $2}')"
  if [ $? != 0 ] || [ -z "$URL" ];then
...
patchlist="$(wget -qO- https://twisteros.com/Patches/Twister_OS/URLs)"
